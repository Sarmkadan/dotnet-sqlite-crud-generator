...
public static class PerformanceMonitorJsonExtensions
{
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is null.</exception>
    public static string ToJson(this OperationMetrics value, bool indented = false)
    {
        ArgumentNullException.ThrowIfNull(value);
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="json"/> is null or empty.</exception>
    /// <exception cref="JsonException">Thrown when the JSON is invalid or cannot be deserialized.</exception>
    public static OperationMetrics? FromJsonToOperationMetrics(string json)
    {
        ArgumentException.ThrowIfNullOrEmpty(json);

        return JsonSerializer.Deserialize<OperationMetrics>(json, _jsonOptions);
    }
    ...
    /// <returns>True if deserialization succeeded; otherwise, false.</returns>
    public static bool TryFromJson(string json, out OperationMetrics? value)
    {
        ArgumentException.ThrowIfNullOrEmpty(json);
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="json"/> is null or empty.</exception>
    /// <exception cref="JsonException">Thrown when the JSON is invalid or cannot be deserialized.</exception>
    public static PerformanceReport? FromJsonToPerformanceReport(string json)
    {
        ArgumentException.ThrowIfNullOrEmpty(json);

        return JsonSerializer.Deserialize<PerformanceReport>(json, _jsonOptions);
    }
    ...
    /// <returns>True if deserialization succeeded; otherwise, false.</returns>
    public static bool TryFromJson(string json, out PerformanceReport? value)
    {
        ArgumentException.ThrowIfNullOrEmpty(json);
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is null.</exception>
    public static string ToJson(this MemoryInfo value, bool indented = false)
    {
        ArgumentNullException.ThrowIfNull(value);
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="json"/> is null or empty.</exception>
    /// <exception cref="JsonException">Thrown when the JSON is invalid or cannot be deserialized.</exception>
    public static MemoryInfo? FromJsonToMemoryInfo(string json)
    {
        ArgumentException.ThrowIfNullOrEmpty(json);

        return JsonSerializer.Deserialize<MemoryInfo>(json, _jsonOptions);
    }
    ...
    /// <returns>True if deserialization succeeded; otherwise, false.</returns>
    public static bool TryFromJson(string json, out MemoryInfo? value)
    {
        ArgumentException.ThrowIfNullOrEmpty(json);
